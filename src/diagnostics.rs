...
impl RestrictionFeatures {
    pub fn csv_header() -> &'static str {
        "fen,side_to_move,static_eval_cp,white_score_cp,\
    ...
    pub fn to_csv_row(&self) -> String {
        format!(
            ...
            self.mobility_mg,
            self.mobility_eg,
            self.pawn_structure_mg,
            self.pawn_structure_eg,
            self.king_safety_mg,
            self.king_safety_eg,
            self.freedom,
            self.white_pawn_breaks,
            self.black_pawn_breaks,
            self.liberating_breaks_white,
            self.liberating_breaks_black,
            self.piece_redeployment_white,
            self.piece_redeployment_black
        )
    }
}
